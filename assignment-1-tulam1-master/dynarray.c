 ...
 * Date: 10/13/2019
 * Description: This file is where you should implement your dynamic array. It already contains 
 * skeletons of the functions you need to implement (along with documentation for each function).
 * Feel free to implement any additional functions you might need. Also, don't forget to include 
 * your name and @oregonstate.edu email address.
 ***********************************************************************************************/
...
/****************************************************************************
 * This function would resize the array after the remove function is called.
 ***************************************************************************/
void resize_arr(struct dynarray* da, int cap) {

  void** new_arr = malloc(cap * sizeof(void*));
