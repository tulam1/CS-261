 ...
 * Date: 10/22/2019
 * Description: This file is where you should implement your queue. It already contains
 * skeletons of the functions you need to implement (along with documentation
 * for each function). Feel free to implement any additional functions you might need.
 * Also, don't forget to include your name and @oregonstate.edu email address below.
 ***************************************************************************************/
...
int queue_isempty(struct queue* queue) {
  ...
  num = dynarray_check(queue->array);
