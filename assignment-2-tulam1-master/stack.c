 ...
 * Date: 10/22/2019
 * Description: This file is where you should implement your stack.  It already contains
...
void* stack_top(struct stack* stack) {
  ...
  void* top_val = list_top(stack->list);
...
void* stack_pop(struct stack* stack) {
  ...
  void* value = list_pop(stack->list);
